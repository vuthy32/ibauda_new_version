...
public class GCMIntentService extends GCMBaseIntentService {
	...
	private static void generateNotification(Context context, String message) {
       ...
       // String sear_url = "http://iblauda.com/?c=json&m=getCarListpage&country=&car_make=&car_model=&pr_min=&pr_max=&year_min=&year_max=";
       // notificationIntent.putExtra("url_list", sear_url);
